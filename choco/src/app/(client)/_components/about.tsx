  ...
  return (
    <div className='bg-[#ffbb7343] p-10 mt-2'>
     <div className='flex md:flex-row flex-col  items-center md:items-center justify-center space-x-10'>
        <div>
            <img src='chocolate.jpg' alt='' className='h-48 w-96 rounded-sm'/>
        </div>
     <div className='m-2 max-w-[500px]'>
        <p className='text-xl md:text-2xl font-bold text-red-950'>Forget love, I"d Rather Fall In Chocolate</p>
