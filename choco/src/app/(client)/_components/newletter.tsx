        ...
        <section className="mx-auto max-w-6xl px-5 py-14 md:py-20">
            <div className="relative mx-auto flex max-w-4xl flex-col items-center justify-center rounded-3xl px-10 py-14 text-white">
                ...
                <div className="relative mt-6 w-[400px]">
                    <Input
                        className="border-white/40 bg-white/10 placeholder:text-white "
                        placeholder="Enter your email address"
                    />
                    <Button
                        variant="ghost"
                        className="absolute text-black font-bold right-0 top-1/2 mr-1 h-8 -translate-y-1/2 transform  bg-white hover:bg-black hover:text-white"
                        size="sm">
                        Subscribe
                    </Button>
                </div>
